...
之前接触过 React 和 Ng，所以上手Vue较快<font color="red">但是为了防止自己的代码和老项目代码写的大头小易，养成不好习惯，就准备找个项目来学习</font>，同时也为了进一步理解 Vue，所以就有了[eleApp](https://github.com/yxuchen/eleApp)和本项目
